...
*/
function getContent(artObj, contentProc, imgSavePath = defaultImageSaveProc, imgProc = defaultImgProc) {
...
默认图片下载和替换src方法
*/
function defaultImgProc(artObj, imageSaveProc, imageReplaceProc = defaultImageReplaceProc) {
    return new Promise((resolve, reject) => {
...
*/
function downloader(imgsrc, $, element, imageSaveProc, imageReplaceProc) {
